...
export function AddTransactionForm({ accounts, categories, editMode = false, initialData = null }) {
  ...
  // Standard React state for form fields
        ...
        <div>
          ...
          <Select onValueChange={setType} value={type}>
            ...
            <SelectContent className="bg-white border-slate-200 text-slate-800">
              <SelectItem value="EXPENSE" className="text-sm text-red-600 font-medium">
                Expense
              </SelectItem>
              <SelectItem value="INCOME" className="text-sm text-green-600 font-medium">
                Income
              </SelectItem>
            </SelectContent>
          </Select>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                className={cn(
                  "w-full bg-white border-slate-300 text-slate-800 text-left font-normal text-sm hover:bg-slate-50 focus:ring-1 focus:ring-blue-500",
                  !date && "text-slate-400"
                )}
              >

    ...
    <div className="simple-card overflow-hidden">
      <div className="px-5 py-4 border-b border-slate-100 bg-white flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <Select defaultValue={dateRange} onValueChange={setDateRange}>
          <SelectTrigger className="w-full sm:w-[160px] h-8 bg-white border-slate-200 text-slate-700 text-sm">
        ...
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={filteredData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <XAxis dataKey="date" fontSize={12} tickLine={false} axisLine={{ stroke: "#e2e8f0" }} tick={{ fill: "#94a3b8" }} dy={10} />
              <YAxis fontSize={12} tickLine={false} axisLine={{ stroke: "#e2e8f0" }} tickFormatter={(v) => `₹${v}`} tick={{ fill: "#94a3b8" }} dx={-10} />
              <Tooltip
